 ...
 * Kreisdiagramm erstellen -> dieses Servlet gibt Kategorien an jsp -> jsp
 * öffnet sich -> man laesst Kreisdiagramm erstellen -> dieses Servlet wird
 ...
 *
 */
@WebServlet("/KategorieDropDownKreisDiagramm")
public class KategorieDropDownKreisDiagramm extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/diagrammkreis.jsp").forward(request, response);
